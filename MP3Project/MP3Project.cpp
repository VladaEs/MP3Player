...
// MP3Project.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMP3ProjectApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CMP3ProjectApp::OnAppAbout)
...
// Создание CMP3ProjectApp

CMP3ProjectApp::CMP3ProjectApp() noexcept
{
	...
	SetAppID(_T("MP3Project.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CMP3ProjectApp

CMP3ProjectApp theApp;


// Инициализация CMP3ProjectApp

BOOL CMP3ProjectApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CMP3ProjectDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CMP3ProjectView));
	if (!pDocTemplate)
		return FALSE;
...
int CMP3ProjectApp::ExitInstance()
{
...
// Обработчики сообщений CMP3ProjectApp
...
void CMP3ProjectApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
